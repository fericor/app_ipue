...
class IpueColors {
  ...
  static const Color cError = Color.fromARGB(255, 234, 16, 16);

  static const String urlHost = 'https://app.tabernaculodevida.es/ipue_api_v1';
  static const String urlHostNo = 'app.tabernaculodevida.es';
}
